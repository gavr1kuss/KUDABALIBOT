...
## СПАМ (не мероприятие) — СТРОГО отклоняй как Spam:
- Болтовню в чатах, вопросы, ответы, обсуждения
- Вакансии, резюме, поиск работы
- Аренду, продажу, покупку
- Рекламу личных услуг БЕЗ конкретной даты/места (например: «я преподаватель йоги, провожу занятия» — это Spam, а НЕ событие)
- Советы, рекомендации, отзывы
- Сообщения от ботов (содержащие @BaliForumRuBot, @BaliChatBot и т.п.)
- Всё, что не содержит КОНКРЕТНОЕ мероприятие с датой или регулярностью

ВАЖНО: Если нет конкретной даты, конкретного места и конкретного события — это Spam. Простое предложение услуг — это Spam.
